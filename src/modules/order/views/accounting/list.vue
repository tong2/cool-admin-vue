...
const Table = useTable({
	columns: [
		...
		{ label: '子订单编号', prop: 'subOrderNo', minWidth: 120 },
		{ label: '状态', prop: 'status', minWidth: 100 },
		{ label: '仓库', prop: 'warehouse', minWidth: 120 },
		{ label: '交易日期', prop: 'tradeDate', minWidth: 150 },
		{ label: '商品ID', prop: 'productId', minWidth: 120 },
		{ label: '商家编码', prop: 'merchantCode', minWidth: 120 },
		{ label: '订单数量', prop: 'orderQuantity', minWidth: 100 },
		{ label: '订单应付金额', prop: 'orderPayableAmount', minWidth: 120 },
		{ label: '实际平台补贴', prop: 'actualPlatformSubsidy', minWidth: 120 },
		{ label: '达人实际承担优惠金额', prop: 'influencerDiscountAmount', minWidth: 150 },
		{ label: '实销', prop: 'actualSales', minWidth: 100 },
		{ label: '平台补贴扣费（2%）', prop: 'platformSubsidyFee', minWidth: 120 },
		{ label: '平台服务费', prop: 'platformServiceFee', minWidth: 120 },
		{ label: '达人佣金', prop: 'influencerCommission', minWidth: 120 },
		{ label: '团长服务费', prop: 'groupLeaderServiceFee', minWidth: 120 },
		{ label: '成本', prop: 'cost', minWidth: 100 },
		{ label: '快递费', prop: 'shippingFee', minWidth: 100 },
		{ label: '操作费', prop: 'operationFee', minWidth: 100 },
		{ label: '利润', prop: 'profit', minWidth: 100 },
		{ label: '毛利率', prop: 'grossMargin', minWidth: 100 },
